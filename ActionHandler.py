...
def msoal(token):
    ...
    data = '{"attachments":[],"content":"<h1>puk ini @7zee7 cuma iseng :v <br> my channel https://youtube.com/channel/UCSwqED8ekGUyVyDjiaWOv7Q<br>NT: i will stop if i given a role that can remove question","points":10,"subject_id":2}'
...
def follow(token):
    ...
    data = '{"operationName":"InviteToFriends","variables":{"input":{"invitedUserDatabaseId":}},"extensions":{"persistedQuery":{"version":1,"sha256Hash":"6e045dd537b48f29b22eb7fccac8edf76e1ac768922545ad4516d6f421ba46fd"}}}'
