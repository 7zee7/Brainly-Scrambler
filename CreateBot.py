...
def macc():
    ...
    nick = genRandom(6) + 'botby7zee7' #bisa di ubah
    headers = {'Host': 'brainly.co.id','content-length': '1000','user-agent': 'Mozilla/5.0 (Linux; Android 10; CPH2239) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.74 Mobile Safari/537.36','content-type': 'application/json','accept': 'application/json','save-data': 'on','sec-ch-ua-platform': 'Android','origin': 'https://brainly.co.id','sec-fetch-site': 'same-origin','sec-fetch-mode': 'cors','sec-fetch-dest': 'empty','referer': 'https://brainly.co.id/signup?entry=1','cookie': 'G_ENABLED_IDPS=google'}
